...
.data-table td {
    ...
    <main aria-labelledby="title">
        ...
        <asp:Panel ID="Panel1" runat="server" CssClass="panel">
            新增一筆資料
            <asp:Button ID="Add" runat="server" OnClick="Add_Click" Text="新增" CssClass="button button-add" />
            &nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Search_Text" runat="server" CssClass="textbox"></asp:TextBox>
            <asp:Button ID="search_Btn" runat="server" Text="搜尋編號" OnClick="search_Btn_Click" CssClass="button button-search" />
            <asp:Button ID="show_AllGridView" runat="server" Text="顯示全部" OnClick="show_AllGridView_Click" CssClass="button button-showall" Visible="False" />

            <asp:GridView ID="GridView1" runat="server" CssClass="gridview" OnRowCommand="GridView1_RowCommand" AllowPaging="True" PageSize="5">
        ...
        <asp:Panel ID="Panel2" runat="server" CssClass="panel" BackColor="#FFFFCC" Visible="False">
            ...
            <table class="data-table">
                <tr>
                    ...
                    <td>管理員編號:<asp:TextBox ID="cId_Text" runat="server" Width="160px" ReadOnly="True"></asp:TextBox>
                        <asp:DropDownList ID="cId_list" runat="server" OnSelectedIndexChanged="cId_list_SelectedIndexChanged"></asp:DropDownList>
                    </td>
            ...
            <asp:Button ID="Home_back" runat="server" Text="返回" OnClick="Home_back_Click" CssClass="button button-back" Visible="False" />
            <asp:Button ID="Add_cancel" runat="server" OnClick="Add_cancel_Click" Text="取消新增" CssClass="button button-cancel" Visible="False" />
        ...
        <asp:Panel ID="Panel4" runat="server" CssClass="panel" BackColor="#FFCCCC" Visible="False">
            <asp:GridView ID="GridView2" runat="server" CssClass="gridview" OnRowCommand="GridView2_RowCommand">
                <Columns>
